package com.nidoham.skymate.util;
...
import com.nidoham.skymate.BuildConfig;
import com.nidoham.skymate.R;

import com.nidoham.skymate.App;
...
public final class Localization {
    ...
    public static String relativeTimeOrTextual(@Nullable final Context context,
        ...
        if (parsed == null) {
            return textual;
        } else if (BuildConfig.DEBUG && context != null && PreferenceManager
